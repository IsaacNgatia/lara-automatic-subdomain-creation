...
<head>
    ...
    <!-- TITLE -->
    <title>ISP Kenya Billing </title>

    <!-- FAVICON -->
    <link rel="icon" href="{{ asset('build/assets/images/brand-logos/temp_fav.ico') }}" type="image/x-icon">
    ...
    @include('clients.layouts.components.styles')
...
<body>
    ...
    @include('clients.layouts.components.switcher')
    ...
    <div class="page">
        ...
        @include('clients.layouts.components.header')

        <!-- END HEADER -->

        <!-- SIDEBAR -->

        @include('clients.layouts.components.sidebar')
        ...
        @include('clients.layouts.components.search-modal')
    ...
    @include('clients.layouts.components.scripts')
