    ...
    <div class="xl:col-span-12 col-span-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                @endif
                <form class="grid grid-cols-12 gap-4 mt-0" wire:submit="createHotspotServicePlan">
                    <div class="md:col-span-6 col-span-12">
                        <label class="form-label">Package Name</label>
                        <input type="text" class="form-control" placeholder="Name of Package" aria-label=""
                            wire:model="createHotspotServicePlanForm.name">
                        @error('createHotspotServicePlanForm.name')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="md:col-span-6 col-span-12">
                        <label class="form-label">Profile</label>
                        {{-- <input type="text" class="form-control" placeholder="6M/6M" aria-label="First name"
                            wire:model="createHotspotServicePlanForm.rate_limit"> --}}
                        <select id="inputState" class="form-select !py-[0.59rem]"
                            wire:model="createHotspotServicePlanForm.profile">
                        ...
                        @error('createHotspotServicePlanForm.profile')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="md:col-span-6 col-span-12">
                        ...
                        <input type="text" class="form-control" placeholder="Price of the Package"
                            aria-label="First name" wire:model="createHotspotServicePlanForm.price">
                        @error('createHotspotServicePlanForm.price')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="md:col-span-6 col-span-12">
                        ...
                        <select id="inputState" class="form-select !py-[0.59rem]"
                            wire:model="createHotspotServicePlanForm.billing_cycle">
                        ...
                        @error('createHotspotServicePlanForm.billing_cycle')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-span-12">
                        <button class="ti-btn btn-wave ti-btn-primary-full w-full" wire:loading.attr="disabled">
                            <span wire:loading.remove>Add Hotspot Package</span>
