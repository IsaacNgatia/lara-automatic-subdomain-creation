<div class="grid grid-cols-12">
    <div class="xl:col-span-12 col-span-12">
        <div class="box">
            <div class="box-header justify-around">
                <div class="box-title">
                    Update PPPoE User
                </div>
            ...
            <div x-data="{ routerStatus: @js($routerStatus) }" x-init="$nextTick(() => { $dispatch('checkout-status'); if (!routerStatus) { setTimeout(() => { $dispatch('checkout-status') }, 5000) } })" class="box-body">
                ...
                @endif
                <form wire:submit="updatePppoeUser" class="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-0">
                    <div>
                        ...
                        <div class="grid grid-cols-12 gap-4 mt-4">
                            <div class=" col-span-12">
                                ...
                                <input wire:model.live="username" type="text"
                                    class="form-control {{ !$routerStatus ? 'text-muted' : '' }}" placeholder="Jane Doe"
                                    aria-label="User name" {{ !$routerStatus ? 'disabled' : '' }}>
                                @error('username')
                            ...
                            <div class="col-span-12">
                                ...
                                <input wire:model="email" type="email" class="form-control" id="pppoeUserEmail">
                                @error('email')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-12">
                                ...
                                <input wire:model="location" type="text" class="form-control" id="inputAddress"
                            ...
                            <div class=" col-span-12">
                                ...
                                <div class="flex justify-between gap-4">
                                    <input wire:model.live="password" type="text"
                                        class="form-control {{ !$routerStatus ? 'text-muted' : '' }}" id="pppoePass"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-12 gap-4 mt-4">
                            ...
                            <div class=" col-span-12">
                                ...
                                <input wire:model="remoteAddress" type="text"
                                    class="form-control {{ !$routerStatus ? 'text-muted' : '' }}" id="remoteAddress"
                                    {{ !$routerStatus ? 'disabled' : '' }}>
                                @error('remoteAddress')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class=" col-span-12">
                                ...
                                <select wire:model="selectedProfile" id="pppoeUserProfile"
                            ...
                            <div class="col-span-12">
                                <label for="pppoeUserService" class="form-label">Service</label>
                                <select wire:model="service" id="pppoeUserService"
                                    class="form-select !py-[0.59rem]  {{ !$routerStatus ? 'opacity-70' : '' }}"
                                    {{ !$routerStatus ? 'disabled' : '' }}>
                            ...
                            <div class="col-span-12">
                                <label for="pppoeUserStatus" class="form-label">Status</label>
                                <select wire:model="status" id="pppoeUserStatus"
                                    class="form-select !py-[0.59rem] {{ !$routerStatus ? 'opacity-70' : '' }}"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-12 gap-4 mt-4">
                            ...
                            <div class="col-span-12">
                                ...
                                <div class="flex justify-between gap-4">
                                    <select wire:model="billingCycle" id="pppoeBillingCycle"
                            ...
                            <div class="col-span-12">
                                ...
                                <input wire:model="phone" id="pppoePhone" type="text" class="form-control"
                                    placeholder="Phone Number" aria-label="User Phone Number">
                                @error('phone')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-12">
                                <button type="submit" class="ti-btn btn-wave ti-btn-primary-full w-full">
                                    ...
                                    <span wire:loading wire:target="updatePppoeUser" class="me-2">Updating
                                        User</span>
                                    <span wire:loading wire:target="updatePppoeUser" class="loading"><i
                                            class="ri-loader-2-fill text-[1rem] animate-spin"></i></span>
                                    <span wire:loading.class="hidden" wire:target="updatePppoeUser"
                                        class="me-2">Update User</span>
                                </button>
                            </div>
                        </div>
                    </div>
