    ...
    <div class="xl:col-span-12 col-span-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <form class="grid grid-cols-12 gap-4 mt-0" wire:submit="createStaticServicePlan">
                    <div class="md:col-span-6 col-span-12">
                        <label class="form-label">Package Name</label>
                        <input type="text" class="form-control" placeholder="Name of Package" aria-label=""
                            wire:model="createStaticServicePlanFormm.name">
                        @error('createStaticServicePlanFormm.name')
                    ...
                    <div class="md:col-span-6 col-span-12">
                        ...
                        <input type="text" class="form-control" placeholder="6M/6M" aria-label="First name"
                            wire:model="createStaticServicePlanFormm.rate_limit">
                        @error('createStaticServicePlanFormm.rate_limit')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="md:col-span-6 col-span-12">
                        ...
                        <input type="text" class="form-control" placeholder="Price of the Package"
                            aria-label="First name" wire:model="createStaticServicePlanFormm.price">
                        @error('createStaticServicePlanFormm.price')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-6 col-span-12">
                        ...
                        <select id="inputState" class="form-select !py-[0.59rem]"
                            wire:model="createStaticServicePlanFormm.billing_cycle">
                        ...
                        @error('createStaticServicePlanFormm.billing_cycle')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-span-12">
                        <button class="ti-btn btn-wave ti-btn-primary-full w-full" wire:loading.attr="disabled">
                            <span wire:loading.remove>Add Static Package</span>
                            <span wire:loading>Adding Static Package...</span>
                        </button>
                    </div>
                </form>
            </div>
