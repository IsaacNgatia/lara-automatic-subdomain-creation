     ...
     {{-- <li>
         <div>
             ...
             <p class="mb-2">
                 ...
                 <a class="text-secondary" href="javascript:void(0);"><u>#beautiful
                         day</u></a>.<span
     ...
     <li>
         <div>
             ...
             <p class="text-[#8c9097] dark:text-white/50 mb-0">
                 ...
                 ipsam
                 temporibus inventore ullam tempora eligendi libero
                 sequi
                 dignissimos
     ...
     <li>
         <div>
             ...
             <p class="text-[#8c9097] dark:text-white/50">you are
                 already
                 feeling
                 the tense atmosphere of the video playing in the
                 background</p>
