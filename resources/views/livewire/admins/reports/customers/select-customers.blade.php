<div>
                    ...
                    <form wire:submit="generateReport" class="sm:grid grid-cols-12 gap-4 items-center">
                        ...
                        <div class="xl:col-span-9 col-span-12">
                            <div class="flex justify-between items-center">
                                ...
                                <p class="flex gap-1"><span>Customers: </span><span>
                                        {{ sizeof($selectedCustomers) }}</span>
                                </p>
                            </div>
                            <!-- Select -->
                            <div class="relative">
                                <!-- Select -->
                                <x-multi-select model="selectedCustomers" class="select-custom"
                                    placeholderValue="Type to search users" :options="$customers" valueKey="id"
    ...
    @if ($createReport)
        ...
        <livewire:admins.reports.customers.components.customers-report :startingDate="$startingDate" :endingDate="$endingDate"
            :customersIds="$selectedCustomers" lazy />
    @endif
</div>
